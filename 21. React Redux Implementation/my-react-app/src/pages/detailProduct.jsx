    ...
    <div className="flex flex-row justify-center items-center bg-slate-800 min-h-screen">
      {Object.keys(product).length > 0 && (
        <div className="flex bg-white rounded-lg">
          <div className="flex-none w-48 relative rounded-l-lg overflow-hidden">
          ...
          <form className="flex-auto p-6">
            <div className="flex flex-col">
              ...
              <div className="text-lg font-semibold text-slate-500">USD {product.price}</div>
              <div className="w-full flex-none text-sm font-medium text-slate-700 mt-2">
                Review {product.rating.rate}/5 ({product.rating.count})
              </div>
            </div>
            <div className="flex space-x-4 mb-6 text-sm font-medium mt-6">
